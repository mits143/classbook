...
import kotlinx.android.synthetic.main.fragment_classes_fav.bookLoading
import kotlinx.android.synthetic.main.fragment_classes_fav.loader
import kotlinx.android.synthetic.main.fragment_classes_fav.placeList1RecyclerView
import retrofit2.Response

class ClassesFavFragment : Fragment(), ActivityFavoriteView.MainView {
    ...
    override fun onSuccess(responseModel: Response<FavoriteResponse>) {
        if (responseModel.body() != null && responseModel.body()!!.isNotEmpty()) {
            ...
            for (i in responseModel.body()!!.indices) {
                if (TextUtils.equals(responseModel.body()!![i].entityName, "class")) {
