...
import com.app.classbook.model.response.SubTopicData
...
class SubTopicAdapter(private val dataList: ArrayList<SubTopicData>) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var itemClickListener: OnItemClickListener

    interface OnItemClickListener {
        fun onItemClick(view: View, obj: SubTopicData, position: Int)
    }
