...
import com.app.classbook.model.response.SubjectVideoData
...
class SubVideoAdapter(private val dataList: ArrayList<SubjectVideoData>) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var itemClickListener: OnItemClickListener

    interface OnItemClickListener {
        fun onItemClick(view: View, obj: SubjectVideoData, position: Int)
    }
