...
import kotlinx.android.synthetic.main.app_education_home_1_new_course_item2.view.*

class BoardAdapter1(private val dataList: List<BoardsData>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.app_education_home_1_new_course_item2, parent, false)
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewHolder is ItemViewHolder) {
            ...
            viewHolder.itemNameTextView1.text = data.fullName
    ...
    inner class ItemViewHolder internal constructor(view: View) : RecyclerView.ViewHolder(view) {
        ...
        internal var itemNameTextView1: TextView = view.itemNameTextView1
