...
import com.app.classbook.model.response.LevelDifferenceIncomeModel

class LevelAdapter(
    internal var context: Context,
    val dataList: ArrayList<LevelDifferenceIncomeModel>,
    val clickListener: (LevelDifferenceIncomeModel) -> Unit
) :
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(data: LevelDifferenceIncomeModel, clickListener: (LevelDifferenceIncomeModel) -> Unit) {
