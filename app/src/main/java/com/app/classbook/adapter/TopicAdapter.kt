...
import com.app.classbook.model.response.SubjectTopicData
...
class TopicAdapter(private val dataList: ArrayList<SubjectTopicData>) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var itemClickListener: OnItemClickListener

    interface OnItemClickListener {
        fun onItemClick(view: View, obj: SubjectTopicData, position: Int)
    }
