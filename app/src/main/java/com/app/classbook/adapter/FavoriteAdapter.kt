...
class FavoriteAdapter(private val dataList: List<FavoriteResponseItem>) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var itemClickListener: OnItemClickListener

    interface OnItemClickListener {
        fun onItemClick(view: View, obj: FavoriteResponseItem, position: Int)
    }
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewHolder is ItemViewHolder) {
            ...
            viewHolder.txtTitle.text = data.name
            viewHolder.txtDesc.text = data.entityName
    ...
    inner class ItemViewHolder internal constructor(view: View) : RecyclerView.ViewHolder(view) {
        ...
        internal var txtTitle: TextView = view.txtTitle
        internal var txtDesc: TextView = view.txtDesc
