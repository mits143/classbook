...
import com.app.classbook.model.response.CourseVideoListdata
...
class CourseSubVideoAdapter(private val dataList: ArrayList<CourseVideoListdata>) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var itemClickListener: OnItemClickListener

    interface OnItemClickListener {
        fun onItemClick(view: View, obj: CourseVideoListdata, position: Int)
    }
...
//            Glide.with(viewHolder.placeImageView.context).load(data. )
