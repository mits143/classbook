...
import com.app.classbook.model.response.SubTopicModelX
...
class CoursesSubTopicAdapter(private val dataList: ArrayList<SubTopicModelX>) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var itemClickListener: OnItemClickListener

    interface OnItemClickListener {
        fun onItemClick(view: View, obj: SubTopicModelX, position: Int)
    }
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewHolder is ItemViewHolder) {
            ...
            Glide.with(viewHolder.placeImageView.context).load(data.imageUrl)
