...
class FragmentCoursesPresenter : FragmentCoursesView.MainPresenter {

    var context: Context? = null
    var mainView: FragmentCoursesView.MainView? = null

    @NonNull
    var disposable: Disposable? = null

    constructor(context: Context?, mainView: FragmentCoursesView.MainView?) {
