...
class FragmentSubscriptionPresenter : FragmentSubscriptionView.MainPresenter {

    var context: Context? = null
    var mainView: FragmentSubscriptionView.MainView? = null

    @NonNull
    var disposable: Disposable? = null

    constructor(context: Context?, mainView: FragmentSubscriptionView.MainView?) {
