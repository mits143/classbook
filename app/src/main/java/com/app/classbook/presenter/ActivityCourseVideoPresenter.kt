...
class ActivityCourseVideoPresenter : ActivityCourseVideoView.MainPresenter {

    var context: Context? = null
    var mainView: ActivityCourseVideoView.MainView? = null

    @NonNull
    var disposable: Disposable? = null

    constructor(context: Context?, mainView: ActivityCourseVideoView.MainView?) {
