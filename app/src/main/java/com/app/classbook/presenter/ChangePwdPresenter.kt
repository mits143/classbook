...
class ChangePwdPresenter : ChangePwdView.MainPresenter {

    var context: Context? = null
    var mainView: ChangePwdView.MainView? = null

    @NonNull
    var disposable: Disposable? = null

    constructor(context: Context?, mainView: ChangePwdView.MainView?) {
