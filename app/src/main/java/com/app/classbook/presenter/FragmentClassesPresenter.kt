...
class FragmentClassesPresenter : FragmentClassesView.MainPresenter {

    var context: Context? = null
    var mainView: FragmentClassesView.MainView? = null

    @NonNull
    var disposable: Disposable? = null

    constructor(context: Context?, mainView: FragmentClassesView.MainView?) {
