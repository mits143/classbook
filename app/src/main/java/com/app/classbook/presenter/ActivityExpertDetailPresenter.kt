...
class ActivityExpertDetailPresenter : ActivityExpertDetailView.MainPresenter {

    var context: Context? = null
    var mainView: ActivityExpertDetailView.MainView? = null

    @NonNull
    var disposable: Disposable? = null

    constructor(context: Context?, mainView: ActivityExpertDetailView.MainView?) {
