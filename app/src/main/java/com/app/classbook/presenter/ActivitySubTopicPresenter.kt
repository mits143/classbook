...
class ActivitySubTopicPresenter : ActivitySubTopicView.MainPresenter {

    var context: Context? = null
    var mainView: ActivitySubTopicView.MainView? = null

    @NonNull
    var disposable: Disposable? = null

    constructor(context: Context?, mainView: ActivitySubTopicView.MainView?) {
