...
class ActivitySubVideoPresenter : ActivitySubVideoView.MainPresenter {

    var context: Context? = null
    var mainView: ActivitySubVideoView.MainView? = null

    @NonNull
    var disposable: Disposable? = null

    constructor(context: Context?, mainView: ActivitySubVideoView.MainView?) {
