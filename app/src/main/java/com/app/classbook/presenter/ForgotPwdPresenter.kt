...
class ForgotPwdPresenter : ForgotPwdView.MainPresenter {

    var context: Context? = null
    var mainView: ForgotPwdView.MainView? = null

    @NonNull
    var disposable: Disposable? = null

    constructor(context: Context?, mainView: ForgotPwdView.MainView?) {
