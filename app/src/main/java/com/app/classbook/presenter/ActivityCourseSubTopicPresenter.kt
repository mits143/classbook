...
class ActivityCourseSubTopicPresenter : ActivityCourseSubTopicView.MainPresenter {

    var context: Context? = null
    var mainView: ActivityCourseSubTopicView.MainView? = null

    @NonNull
    var disposable: Disposable? = null

    constructor(context: Context?, mainView: ActivityCourseSubTopicView.MainView?) {
