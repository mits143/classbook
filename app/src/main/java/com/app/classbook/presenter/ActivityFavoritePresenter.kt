...
class ActivityFavoritePresenter : ActivityFavoriteView.MainPresenter {

    var context: Context? = null
    var mainView: ActivityFavoriteView.MainView? = null

    @NonNull
    var disposable: Disposable? = null

    constructor(context: Context?, mainView: ActivityFavoriteView.MainView?) {
