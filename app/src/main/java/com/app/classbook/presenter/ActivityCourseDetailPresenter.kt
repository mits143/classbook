...
class ActivityCourseDetailPresenter : ActivityCourseDetailView.MainPresenter {

    var context: Context? = null
    var mainView: ActivityCourseDetailView.MainView? = null

    @NonNull
    var disposable: Disposable? = null

    constructor(context: Context?, mainView: ActivityCourseDetailView.MainView?) {
