...
class ActivityTopicPresenter : ActivityTopicView.MainPresenter {

    var context: Context? = null
    var mainView: ActivityTopicView.MainView? = null

    @NonNull
    var disposable: Disposable? = null

    constructor(context: Context?, mainView: ActivityTopicView.MainView?) {
