...
class FragmentTransactionPresenter : FragmentTransactionView.MainPresenter {

    var context: Context? = null
    var mainView: FragmentTransactionView.MainView? = null

    @NonNull
    var disposable: Disposable? = null

    constructor(context: Context?, mainView: FragmentTransactionView.MainView?) {
