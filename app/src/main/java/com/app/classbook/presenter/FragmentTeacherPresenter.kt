...
class FragmentTeacherPresenter : FragmentTeacherView.MainPresenter {

    var context: Context? = null
    var mainView: FragmentTeacherView.MainView? = null

    @NonNull
    var disposable: Disposable? = null

    constructor(context: Context?, mainView: FragmentTeacherView.MainView?) {
