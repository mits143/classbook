...
class ActivityLearnEarnPresenter : ActivityLearnEarnView.MainPresenter {

    var context: Context? = null
    var mainView: ActivityLearnEarnView.MainView? = null

    @NonNull
    var disposable: Disposable? = null

    constructor(context: Context?, mainView: ActivityLearnEarnView.MainView?) {
    ...
    override fun loadDataReg(
        ...
        if (NetWorkConection.isNEtworkConnected(context!!)) {
            disposable = ApiClient.instance
                .learnandearnregistrationprocesslist(
                    token
                )
    ...
    override fun loadDataLearnEarn(
        token: String
    ) {
        mainView!!.showProgressbar()
